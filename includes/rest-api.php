...
function sitetop_handle_api_shorten() {
    ...
    /* ── CHẶN TĂNG DẦN + CHỐNG SPAM API — CHỈ ÁP CHO /api, TUYỆT ĐỐI KHÔNG CHO /st ──
       SỰ CỐ 08/09/2026 18:46: một publisher thật bị khoá tài khoản 24 giờ ("Thử lại sau
       23.3 giờ") chỉ vì dán liên kết nhanh /st ra công khai. /st là URL cho NGƯỜI XEM bấm,
       mà rổ chống spam lại đo theo TÀI KHOẢN chủ token — nên mỗi visitor bấm vào đều tính
       vào rổ của chủ link. Link hơi đông người bấm là chủ tài khoản bị khoá, trong khi
       chính họ không gửi request nào.

       /api mới là kênh máy-gọi-máy: một máy chủ, một token, đo theo tài khoản mới đúng.
       /st thì rổ theo IP của người xem đã có sẵn ở lớp anti-ddos, không cần thêm gì.
