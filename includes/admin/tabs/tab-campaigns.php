...
<div style="padding:0 20px 20px">
    <form method="post" enctype="multipart/form-data">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px">
            ...
            <div><label <?php echo $lbl; ?>>Giá/lượt (KH trả)</label><input name="price_per_view" id="adm_price" type="number" value="<?php echo linkngon_get_option('keyword_price_1step',1200); ?>" <?php echo $inp; ?> style="width:100%;height:36px;border:2px solid #0073aa;border-radius:4px;padding:0 8px;font-size:13px;font-weight:700;color:#0073aa" onchange="admUpdateEstimate()"></div>
