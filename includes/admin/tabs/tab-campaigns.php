...
<div style="padding:0 20px 20px">
    <form method="post" enctype="multipart/form-data">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px">
            ...
            <?php
$oe = array(70=>(int)linkngon_get_option('onsite_extra_70',0),80=>(int)linkngon_get_option('onsite_extra_80',0),90=>(int)linkngon_get_option('onsite_extra_90',100),100=>(int)linkngon_get_option('onsite_extra_100',200),120=>(int)linkngon_get_option('onsite_extra_120',250),150=>(int)linkngon_get_option('onsite_extra_150',300));
?>
...
<ul class="subsubsub" style="margin:0;float:none">
    <li><a href="?page=linkngon-campaigns<?php echo $search_filter?'&s='.urlencode($search_filter):''; ?>" <?php echo !$status_filter?'class="current"':''; ?>>Tất cả <span class="count">(<?php echo intval($total); ?>)</span></a> |</li>
...
<div class="tablenav bottom">
    <div class="tablenav-pages">
        <?php for($i=1;$i<=$total_pages;$i++): ?>
            ...
            <?php else: ?>
                <a class="button" href="?page=linkngon-campaigns<?php echo $status_filter?"&status=".urlencode($status_filter):""; ?><?php echo $search_filter?"&s=".urlencode($search_filter):""; ?>&paged=<?php echo $i; ?>"><?php echo $i; ?></a>
            <?php endif; ?>
        <?php endfor; ?>
    </div>
</div>
