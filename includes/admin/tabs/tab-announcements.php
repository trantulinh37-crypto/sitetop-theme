...
function loadAnnouncements() {
    ajax('linkngon_admin_get_announcements', {}, function(r) {
        if (!r.success) return;
...
function createAnnouncement() {
    ...
    ajax('linkngon_admin_create_announcement', {
        title: title,
        message: message,
...
function toggleAnn(id, status) {
    ajax('linkngon_admin_update_announcement', { id: id, status: status }, function(r) {
...
function deleteAnn(id) {
    ...
    ajax('linkngon_admin_delete_announcement', { id: id }, function(r) {
