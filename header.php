        ...
        <?php if (is_user_logged_in()): $u = wp_get_current_user(); $is_admin = in_array('administrator', (array) $u->roles, true); ?>
            ...
            <div style="position:relative" class="ln-switcher-wrap">
                ...
                <div class="ln-switcher-menu">
                    ...
                    <a href="<?php echo home_url('/dashboard'); ?>"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>User</a>
                    <a href="<?php echo home_url('/customer-dashboard'); ?>"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>Customer</a>
                </div>
            </div>
            <?php else : ?>
            <a href="<?php echo linkngon_get_dashboard_url(); ?>" style="color:#2C2C3A;text-decoration:none">Dashboard</a>
            <?php endif; ?>
